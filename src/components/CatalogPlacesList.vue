<template>
  <div class="places-list">
    ...
    <AppPopup v-show="isModalVisible" @closePopup="closeLoginModal">
      <AppLogin />
    </AppPopup>
  </div>
</template>
...
<script>
import PlaceItem from './CatalogPlaceItem.vue';
...
export default {
  ...
  computed: {
    isShowMore() {
      return this.getRecordsCount - this.getStores.length > 0;
    },
    ...mapGetters(['getStores', 'getRecordsCount', 'findStoreByUUID']),
